      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-12 bg-background min-h-screen overflow-y-auto relative">
        ...
        >
            ...
            <Form onSubmit={handleSignIn}>
              ...
              <div>
                <div className="flex justify-between mb-2">
                  <label htmlFor="password" className="block font-mono uppercase tracking-widest text-[11px] text-text-body uppercase">Password</label>
                  <Link href="#" className="text-[11px] font-mono uppercase tracking-widest text-primary hover:underline uppercase">Forgot?</Link>
                </div>
                <Input 
                  type="password" 
                  id="password"
          ...
          <p className="mt-8 text-center text-text-body font-sans text-base">
            ...
            <Link href="/sign-up" className="btn btn-link btn-sm text-primary px-1 hover:underline">
              Create Account
            </Link>
          </p>
